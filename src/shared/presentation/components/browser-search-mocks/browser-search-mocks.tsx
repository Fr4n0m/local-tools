...
export function BrowserPreviewMock({
  ...
  return (
    <div className={joinClasses(styles.browserFrame, className)}>
      <div className={styles.tabStrip}>
        ...
        <div className={styles.tabs}>
          <BrowserTab iconUrl={tabIconUrl} label={label} theme="dark" />
          <BrowserTab iconUrl={lightIconUrl} label={label} theme="light" />
          <button
